		...
		<div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
			<div class="d-flex flex-column align-content-end">
				<div class="app-auth-body mx-auto">	
					...
					<form class="auth-form login-form" method="POST" action="cek-login-mahasiswa.php">         
							<div class="email mb-3">
								<label class="sr-only" for="nim">NIM</label>
								<input id="nim" name="nim" type="text" class="form-control" placeholder="Nomor Induk Mahasiswa" required="required">
							</div><!--//form-group-->
